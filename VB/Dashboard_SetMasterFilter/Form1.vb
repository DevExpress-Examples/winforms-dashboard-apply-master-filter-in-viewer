...
Namespace Dashboard_SetMasterFilter
	Partial Public Class Form1
		...
		Private Sub DashboardViewer1_CustomizeDashboardTitle(ByVal sender As Object, ByVal e As CustomizeDashboardTitleEventArgs)
			...
			Dim setMasterFilterItem As DashboardToolbarItem = New DashboardToolbarItem("Set Master Filter", New Action(Of DashboardToolbarItemClickEventArgs)(Sub(args)
				SetMasterFilterMethod()
			End Sub))
